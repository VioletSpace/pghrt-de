...
\usepackage[T1]{fontenc} % hyphenation on umlauts
\usepackage{hyperref}
\usepackage{float}
\usepackage{csquotes}
...
\title{EIN PRAKTISCHER LEITFADEN ZUR FEMINISIERENDEN HORMONERSATZTHERAPIE}
...
Der Zweck dieses lebenden Dokuments ist es, meine Gedanken und Meinungen zur feminisierenden Hormonersatztherapie zu katalogisieren, da ich die verschiedenen Community-Wikis für unpraktisch halte. Sie sind zwar durchaus wertvolle Ressourcen, aber meiner Meinung nach sind diese Wikis für Menschen, die mehr an klaren, umsetzbaren Anleitungen interessiert sind als daran, jeden halbwegs relevanten biologischen Prozess und jedes Diagramm zu begreifen, nicht besonders nützlich. Mein Ziel ist es, einen umfassenden aber kompakten Leitfaden mit vereinfachten, direkten Antworten auf die häufigsten Fragen zur sicheren und wirksamen Durchführung einer Hormonersatztherapie zu erstellen, die mir im Laufe der Jahre gestellt wurden. Diese lebensrettende Medizin soll dabei sowohl für Menschen, die eine Hormonersatztherapie in Betracht ziehen, als auch für bereits etablierte Transsexuelle zu entmystifiziert werden. Daher gehe ich davon aus, dass du mit den Auswirkungen der Hormonersatztherapie vertraut bist. Falls du damit nicht vertraut sein solltest: Eine Hormonersatztherapie bewirkt viel, wahrscheinlich mehr, als du denken. Sie ist großartig. \textbf{Eine Geschlechtsumwandlung ist wirklich cool und macht Spaß. Ich kann sie nur empfehlen.} Du verdienst eine hochwertige medizinische Versorgung während deiner Transition und du bist in der Lage, die besten Entscheidungen für dich selbst zu treffen. Ich hoffe, dass dieses Dokument dir bei deiner Entscheidungsfindung als nützliches Hilfsmittel und als Ausgangspunkt für weiteres Lernen dienen kann, falls du daran interessiert bist.

Und bleib von den Trans-Subreddits weg. Vertrau mir da, okay? Oder wenigstens /r/mtf weil der wirklich besonders schlimm ist. Das sind weder gesunde Orte noch gute Wissensquellen. Du wirst lediglich Jahre später noch verottete Brainworms aus deinem Kopf ziehen. Das ist der beste Rat den ich geben kann.

Was die Männer betrifft sind einige Abschnitte hier sicher hochrelevant, aber es gibt natürlich große Unterschiede in Methoden und Zielen. \href{https://docs.google.com/document/d/1DXFxzN0XTudPZez\_SO61fpqncRLPH\_Be\_QG\_8Pcz9LU/edit?tab=t.0}{Dieser (englische) Leitfaden für maskulinisierende HET} \textcolor{red}{(Achtung: Google Docs link)} sieht vernünftig aus, aber ich habe ihn mir nicht im Detail angeschaut. Benutz dein Gehirn und deine Entscheidungsfähigkeit. Im übrigen sollte jemand tboy Katie Tightpussy erfinden. Oliver Longdick or so. Vielleicht Xavier.

\textbf{Wenn du spenden möchtest um dieses Projekt zu unterstützen,} funktionieren \href{https://cash.app/Katitties}{CashApp}, \href{https://ko-fi.com/katitties}{Ko-Fi}, und \href{https://account.venmo.com/u/katitties}{Venmo}. Ich bedanke mich!

\subsection*{Verwendung dieses Dokuments}

Dieses Dokument ist linear als Abfolge von Fragen und Antworten aufgebaut, sodass jede Frage und jeder Abschnitt inhaltlich auf den jeweils folgenden aufbaut. Es empfiehlt sich, den Text von Anfang bis Ende zu lesen, da die dialogische Struktur darauf ausgelegt ist, nach und nach alle relevanten Fragestellungen zu behandeln – einschließlich solcher, derer man sich möglicherweise zuvor nicht bewusst war. Aufgrund des Umfangs des Dokuments ist es jedoch sinnvoll, sich Zeit zu nehmen und es gegebenenfalls in mehreren Etappen zu lesen.

Zur gezielten Navigation kann das Inhaltsverzeichnis verwendet werden, um bei Bedarf zu einem bestimmten Abschnitt oder einer bestimmten Frage zu navigieren, insbesondere bei erneutem Lesen. Ich empfehle dir, diese Seite/dieses Dokument zu speichern, damit du jederzeit darauf zurückgreifen kannst, wenn du Fragen zu deiner Hormonersatztherapie haben. Es ist viel Information auf einmal, daher ist es in Ordnung, wenn für dich nicht alle Inhalte sofort vollständig verständlich sind. Es besteht kein Zeitdruck.

\noindent\textbf{\href{pghrt.pdf}{Dieses Dokument kann als PDF heruntergeladen werden. Bitte mach das auch.}}

\noindent\href{pghrtgretchensversion.txt}{Alternativ kannst du auch eine (englische) .txt-Version im Stil der 90er- und 00er-Jahre lesen, wenn du möchtest.} Diese wird jedoch nicht auf dem neuesten Stand bleiben.

\noindent\textbf{Wenn du an einer Übersetzung oder einer anderen alternativen Version interessiert bist, melden dich bitte bei uns!}
...
\subsection{Ist es sicher, Östrogen zu nehmen?}

Mit modernen bioidentischen Hormonen könnte die HET nicht sicherer sein. Du veränderst lediglich den primäre Geschlechtshormon mit dem dein Körper arbeitet, und verschiebst damit das Gleichgewicht der Hormone, die sich bereits in deinem Körper befinden. Selbst wenn die Details der Ergebnisoptimierung komplex werden, ist das Grundprinzip der Veränderung deiner Biologie sehr verzeihlich.
Der Körper ist formbar, und du wirst in der Lage sein, dich an das anzupassen, was sich für dich richtig anfühlt.

\subsection{Welche Verabreichungsform sollte ich für Östrogen wählen?}

Injektionen. Sie sind insgesamt die zuverlässigste, einfachste, konsistenteste, sicherste und kostengünstigste Form der Hormonersatztherapie. Für manche werden Injektionen zu einem Ritual, auf das sie sich freuen, für andere können sie sogar Spaß machen.

\noindent\underline{\textbf{Aber bedenke: Jedes Östrogen ist besser als kein Östrogen.}}

\subsection{Warum empfielst du keine Tabletten, Pflaster oder Gels?}

Vor allem haben alle drei erhebliche Nachteile, die Injektionen nicht haben. Es ist nicht so, dass sie nicht wirken, sondern dass du etwas Besseres verdienst, als erhebliche Nachteile in Kauf nehmen zu müssen. Lass mich wiederholen: \textbf{Alle Formen der Hormonersatztherapie können zufriedenstellende Ergebnisse erzielen}, aber das bedeutet nicht, dass alle Formen der Hormonersatztherapie gleichwertig oder gar gut sind.

\subsection{Ist die Östrogendosis bei allen Verabreichungswegen oder -formen gleich?}

Nein. Dies ist so wichtig, dass ich es nicht in Abschnitt \ref{MM} „MYTHEN UND SONSTIGES“ verbannt habe. \textbf{Östrogendosierungen können nicht direkt über Typ oder Form hinweg verglichen werden.} 1 mg des einen ist nicht 1 mg des anderen. Verschiedene Arten und Formen haben unterschiedliche Eigenschaften, die beeinflussen, wie viel Östrogen vom Körper aufgenommen wird (\textit{„Bioverfügbarkeit“}), mit welcher Geschwindigkeit und mit welcher Halbwertszeit.

\subsection{Was ist eine “Halbwertszeit”?}

Einfach ausgedrückt ist die \textit{Halbwertszeit} einer Substanz die Zeit, die benötigt wird, bis die Hälfte dieser Substanz verstoffwechselt ist. Im Zusammenhang mit der Hormonersatztherapie bestimmt dies, wie lange eine Dosis in Ihrem Körper aktiv bleibt und somit auch Ihre Dosierungshäufigkeit. Dies wird als Ihr Hormonzyklus bezeichnet und bildet eine Kurve. Die Werte steigen an, erreichen ihren Höhepunkt und fallen dann wieder ab. Die Eigenschaften dieser Kurve (wie sich der Östrogenspiegel im Laufe der Zeit verändert) sind wichtig.

\subsection{Was ist falsch mit Pillen?}

Das größte Problem bei Tabletten ist, dass sie langfristig ein erhöhtes Risiko für Blutgerinnsel und Leberkoagulation mit sich bringen. Die Schwere dieser Risiken kann teilweise gemindert werden, indem man sie sublingual oder bukkal einnimmt (die Tablette entweder unter der Zunge oder zwischen Zahnfleisch und Wange auflösen), anstatt oral (die Tablette normal schlucken), um den First-Pass-Effekt in der Leber zu vermeiden. Selbst bei sublingualer und bukkaler Einnahme wird jedoch häufig ein Teil der Tablette verschluckt, sodass davon auszugehen ist, dass zumindest ein gewisses Risiko bestehen bleibt. Bitte beachte, dass das absolute Risiko nach wie vor gering ist (z. B. ist die Leberbelastung durch \textit{Acetaminophen} um eine Größenordnung höher als durch Östrogen), jedoch \textbf{verstärkt sich dieses Risiko durch das nikotinbedingte Östrogenrisiko noch weiter.} Siehe auch Frage \ref{11-2}.

Darüber hinaus ergeben sich zahlreiche weitere Probleme mit Tabletten aus zwei Hauptmerkmalen: 1) ihrer kurzen Halbwertszeit und schlechten Bioverfügbarkeit und 2) der häufig erforderlichen Einnahme von Antiandrogenen. Das erstgenannte Merkmal macht Tabletten im Vergleich zu Injektionen für eine Monotherapie (siehe unten) weitgehend ungeeignet. Letzteres geht oft mit einer Reihe von negativen Nebenwirkungen einher, die von den verwendeten Antiandrogenen abhängen (siehe Abschnitt \ref{AA} „ANTIANDROGENE”). Zusammen führen diese Eigenschaften zu einer zusätzlichen Variabilität, die schlechte Behandlungspläne und deren Nebenwirkungen (wie z. B. Energielosigkeit/Libidoverlust und langsamere Ergebnisse) häufiger auftreten lassen als bei anderen Verabreichungswegen. Tabletten sind außerdem schwieriger zu lagern und in einigen Märkten teurer als Ampullen. Bitte beachte auch, dass der Import von Tabletten in großen Mengen von ausländischen Händlern zu Problemen mit dem Zoll führen kann, was je nach den Gesetzen deines Landes zu Beschlagnahmungen, finanziellen Verlusten und/oder möglichen rechtlichen Problemen führen kann. \textbf{Wenn jemand fragt, weißt du nicht, wer diese Tabletten bestellt hat.}

\textbf{Wenn du aus irgendeinem Grund Tabletten verwendest dann nimm bitte 4–8 mg sublingual über den Tag verteilt ein.} Eine Dosis von weniger als 4 mg ist fast nie ausreichend.

\subsection{Was ist falsch mit Pflastern?}

\begin{itemize}
  \item Relativ teuer (in der Regel sogar teurer als Tabletten);
  \item Schwieriger selbst zu beschaffen (nur über den Graumarkt);
  \item Erfordern in der Regel ein Antiandrogen (siehe Abschnitt \ref{AA} „ANTIANDROGENE”);
  \item Können zu Hautreizungen führen;
  \item Müssen rund um die Uhr angewendet werden;
  \item Können sich u. U. lösen;
  \item Sind nicht konsistent in der Absorbtionsrate (z. B. bei Hitze);
  \item Sind schwieriger zu horten (schwer in großen Mengen zu erwerben);
  \item Überschreiten oft nicht das Niveau der Menopause, selbst wenn mehrere gleichzeitig angewendet werden.
\end{itemize}

\subsection{Was ist falsch mit Gel?}

\begin{itemize}
  \item Schwierige genaue Dosierung, was zu ungleichmäßigen Werten führt;
  \item Erfordert aufgrund der relativ kurzen Halbwertszeit regelmäßige Anwendung;
  \item Kann unangenehm sein (schleimig);
  \item Risiko einer Kontamination durch Kontakt mit anderen Personen;
  \item Erfordert in der Regel ein Antiandrogen (siehe Abschnitt \ref{AA} „ANTIANDROGENE”).
\end{itemize}

Es ist jedoch zu beachten, dass Gel nur minimale Voraussetzungen für die Eigenproduktion erfordert, was unter bestimmten Umständen von Vorteil ist.

\subsection{Was ist mit Pellets?}

\begin{itemize}
  \item Sind meistens weitaus teurer als alle anderen Optionen;
  \item Nur wenige Anbieter;
  \item Die Zeiträume für die Dosierungsanpassung sind sehr lang;
  \item Defekte Pellets können zu unzureichenden Werten führen;
  \item Zerkleinerte/zerbrochene Pellets können zu unerwartet hohen Werten führen;
  \item Im Allgemeinen nicht selbst herstellbar/anwendbar (DIY).
\end{itemize}

Insbesondere der letzte Punkt bedeutet, dass du nur zu den wenigen, wahrscheinlich teuren Anbietern gehen kannst. Möglicherweise hörst du hier zum ersten Mal von Pellets. Siehst du das Problem?

\subsection{Was ist mit Sprays?}

Sprays sind weiterhin relativ experimentell, sodass bislang nur begrenzte Erkenntnisse zu ihnen vorliegen. In ihren Vor- und Nachteilen entsprechen sie weitgehend dem Gel. Ihre Erwähnung erfolgt hier vor allem, um auf ihre Existenz hinzuweisen.

\subsection{Ist der Unterschied so bedeutend?}

\textbf{Ja.} So sehr, dass ich all dies niedergeschrieben habe, um Wiederholungen zu vermeiden und künftig darauf verweisen zu können. Eine korrekt dosierte Injektionsbehandlung stellt derzeit die beste verfügbare Form der Östrogengabe dar, um die Zielwerte einer Monotherapie zu erreichen.

\subsection{Ist diese Tabelle genau?}\label{1-12}
...
\textbf{Nein.} Dieser Leitfaden hat zwar nicht zum Ziel, jedes einzelne Beispiel für Fehlinformationen in den sozialen Medien zu thematisieren, doch die Verbreitung dieser Tabelle sowohl im Internet als auch in von Ärzten bereitgestellten Informationsmaterialien in verschiedenen Sprachen sowie das Ausmaß des dadurch verursachten Schadens machen eine besondere Ausnahme erforderlich, die über die beiläufige Erwähnung in Frage \ref{11-6} hinausgeht.

\textbf{Diese Tabelle ist kategorisch falsch.} Nahezu jeder Aspekt ist in irgendeiner Weise irreführend, mit der einzigen Ausnahme, dass es völlig richtig ist, dass Östrogen keine Stimmveränderungen verursacht. Die für den „erwarteten Beginn” angegebenen Zeiträume sind missverständlich, und die Annahme einer zeitlichen Begrenzung für die „maximale Wirkung” ist so irreführend, dass sie an Kriminalität grenzt. Eine Vielzahl von Veränderungen sind nicht aufgeführt (z. B. psychische Auswirkungen) oder falsch (die Tabelle widerspricht sich in Bezug auf erektile Dysfunktion). Auch die Qualität der Behandlung wird nicht berücksichtigt.

\textbf{Die wichtigsten Aspekte der Tabelle, die einer Nuance bedürfen, werden in diesem Leitfaden erläutert. Die einzige allgemeine Schlussfolgerung sollte lauten, dass Veränderungen in unterschiedlichem Tempo stattfinden.} Die Tabelle weckt falsche Erwartungen, vermittelt ein ungenaues Bild von der Wirkung der Hormonersatztherapie und führt Transgender-Personen in die Irre, indem sie ihr Verständnis von Hormonen einschränkt. Bitte ignoriere sie vollständig. Lass uns nach diesem kleinen Exkurs nun fortfahren.



\section{WARUM INJEKTIONEN}

\subsection{Was macht Injektionen so besonders?}

\textbf{Konsistenz.} Eine gleichmäßige Hormonzufuhr ist ein zentraler Faktor der Hormonersatztherapie. Stabile Hormonspiegel fördern physiologische Stabilität und sind daher therapeutisch vorteilhaft. Selbst die „schlechtesten” Injektionsarten (lies weiter) können einen stabileren Hormonzyklus gewährleisten als andere Formen der Verabreichung, was viele Vorteile mit sich bringt.

\subsection{Sind Antiandrogene mit Injektionen notwendig?}

Im Allgemeinen nein. Ein richtig dosierter und zeitlich abgestimmter Injektionszyklus, der für einen konstant ausreichend hohen Östrogenspiegel sorgt, kann die Testosteronproduktion auf natürliche Weise stoppen. Dadurch entfällt die Notwendigkeit eines Antiandrogens, was in den meisten Fällen vorzuziehen ist. Dies wird als \textit{„Monotherapie”} bezeichnet.

\subsection{Wie funktioniert Monotheraphie?}\label{2-3}

Einfach ausgedrückt ist es dem Gehirn egal, welches Geschlechtshormon im Körper vorhanden ist, solange eine ausreichende Hormonkonzentration besteht. Wenn dem Körper kontinuierlich ausreichend Hormone zur Verfügung stehen, stellt er die Produktion weiterer Hormone ein. Diese „Konsistenz“ ist das, was Injektionen leisten können, womit andere Verabreichungswege Schwierigkeiten haben. Der Versuch, beispielsweise mit Tabletten eine entsprechende Monotherapie durchzuführen, ist in den meisten Fällen sehr wahrscheinlich unmöglich. Genauer gesagt werden in Bezug auf \href{https://en.wikipedia.org/wiki/Hypothalamic-pituitary-gonadal_axis}{die HPG-Achse} das \textit{luteinisierende Hormon} (LH) und das \textit{follikelstimulierende Hormon} (FSH) durch einen Anstieg des Serumspiegels von \textit {Östradiol} (E2)-Spiegel im Serum unterdrückt, wodurch die Testosteronproduktion in den Hoden gehemmt wird.
...
\textbf{Adjusting your dosage in increments of 0.1mg is a difference that should not be expected to be perceived simply because our bodies are not sensitive enough to such exact measurements,} let alone the high possibility of imprecision when performing an injection that makes that certainty of this measurement unlikely. In other words, the accuracy of your dosage is more important than the precision.
